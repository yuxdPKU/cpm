    ...
    const bool writeMiniDst = true)
{
  ...
  mm_match->set_rphi_search_window_lyr1(1.5);
  mm_match->set_rphi_search_window_lyr2(15.0);
  mm_match->set_z_search_window_lyr1(30.0);
  mm_match->set_z_search_window_lyr2(3.);
  mm_match->set_min_tpc_layer(38);
  mm_match->set_test_windows_printout(false);
  ...
  if (G4TRACKING::SC_CALIBMODE)
  {
    ...
    cpmreco->setTrackSource(writeMiniDst ? cpmmindstfinalstring : inputseedFile);
