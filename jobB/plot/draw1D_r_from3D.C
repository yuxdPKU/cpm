...
for (int i = 0; i < nrun; i++)
{
  ...
  draw1Dmap(Form("/sphenix/u/xyu3/workarea/cpm/jobB/merged/run%d_B3_average_correction_histograms.root",runs[i]), Form("%d_cpm",runs[i]), selectZ, h_R_pos_method2[i], h_R_neg_method2[i], h_P_pos_method2[i], h_P_neg_method2[i], h_Z_pos_method2[i], h_Z_neg_method2[i], 4);
}
