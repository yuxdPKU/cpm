...
void draw1Dmap(TString filename, TString tag, double selectZ, TH1*& h_R_pos, TH1*& h_R_neg, TH1*& h_P_pos, TH1*& h_P_neg, TH1*& h_Z_pos, TH1*& h_Z_neg, TH1*& h_N_pos, TH1*& h_N_neg, int color=1, int linestyle=1, bool convert_RP_2_P=false);
...
legend_MI_CPM_LAM->AddEntry(h_P_pos_data_unweighted[i], Form("CPM Unweighted"), "l");
legend_MI_CPM_LAM->AddEntry(h_P_pos_data_weighted[i], Form("CPM weighted"), "l");
...
can_sim_acts->cd(2);
gPad->SetLogy(0);
h_P_pos_sim_acts_unweighted->SetMaximum(0.03);
...
can_sim_acts->cd(4);
gPad->SetLogy(0);
h_Z_pos_sim_acts_unweighted->SetMaximum(0.1);
h_Z_pos_sim_acts_unweighted->SetMinimum(-0.1);
...
can_sim_acts->cd(6);
gPad->SetLogy(0);
h_P_neg_sim_acts_unweighted->SetMaximum(0.03);
...
can_sim_acts->cd(8);
gPad->SetLogy(0);
h_Z_neg_sim_acts_unweighted->SetMaximum(0.1);
h_Z_neg_sim_acts_unweighted->SetMinimum(-0.1);
...
can_sim_acts->Update();
can_sim_acts->SaveAs(Form("figure/resid_vsR_from3D_atZ%d_sim_acts.pdf",(int)selectZ));
...
legend_sim_acts->Draw();
can_sim_acts_leg->SaveAs(Form("figure/resid_vsR_from3D_leg_sim_acts.pdf"));
...
can_sim_genfit->cd(2);
gPad->SetLogy(0);
h_P_pos_sim_genfit_unweighted->SetMaximum(0.03);
...
can_sim_genfit->cd(4);
gPad->SetLogy(0);
h_Z_pos_sim_genfit_unweighted->SetMaximum(0.1);
h_Z_pos_sim_genfit_unweighted->SetMinimum(-0.1);
...
can_sim_genfit->cd(6);
gPad->SetLogy(0);
h_P_neg_sim_genfit_unweighted->SetMaximum(0.03);
...
can_sim_genfit->cd(8);
gPad->SetLogy(0);
h_Z_neg_sim_genfit_unweighted->SetMaximum(0.1);
h_Z_neg_sim_genfit_unweighted->SetMinimum(-0.1);
...
can_sim_genfit->SaveAs(Form("figure/resid_vsR_from3D_atZ%d_sim_genfit.pdf",(int)selectZ));
...
legend_sim_genfit->Draw();
can_sim_genfit_leg->SaveAs(Form("figure/resid_vsR_from3D_leg_sim_genfit.pdf"));
  ...
  bool convert_RP_2_P=false)
{
  ...
  h_N_neg->SetLineColor(color); h_N_neg->SetLineStyle(linestyle); h_N_neg->SetLineWidth(1); h_N_neg->SetFillColor(0); h_R_neg->SetMarkerColor(color);
