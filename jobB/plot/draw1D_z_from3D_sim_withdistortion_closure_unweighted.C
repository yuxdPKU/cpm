...
void draw1D_z_from3D_sim_withdistortion_closure_unweighted(TString phiType="central")
{
gStyle->SetOptStat(0);
...
//draw1Dmap(Form("../output/sim_run%d_acts_unweighted/sim_run%d_acts_unweighted_maxdca0p2_B3_average_correction_histograms.root", run, run), Form("CPM_sim_reco_acts"), selectR, selectPhi, hists_CPM_sim_acts, 2);
//draw1Dmap(Form("../output/sim_run%d_genfit_unweighted/sim_run%d_genfit_unweighted_maxdca0p2_B3_average_correction_histograms.root", run, run), Form("CPM_sim_reco_genfit"), selectR, selectPhi, hists_CPM_sim_genfit, 3);
draw1Dmap(Form("../output/sim_run%d_truth_withdistortion_unweighted/sim_run%d_truth_withdistortion_unweighted_maxdca0p2_B3_average_correction_histograms.root", run, run), Form("CPM_sim_reco_truth_withdistortion"), selectR, selectPhi, hists_CPM_sim_truth, 4);
draw1Dmap(Form("/phenix/u/hpereira/sphenix/work/g4simulations/distortion_maps/average_minus_static_distortion_converted.root"), Form("CPM_sim_input"), selectR, selectPhi, hists_CPM_sim_input, 1, true);
...
TFile* ofile_N = new TFile(Form("Rootfiles/hist_n_1Dz_R%d_withdistortion_unweighted_%s.root",(int)selectR,phiType.Data()),"recreate");
ofile_N->cd();
/*
...
TFile* ofile_R = new TFile(Form("Rootfiles/hist_dr_1Dz_R%d_withdistortion_unweighted_%s.root",(int)selectR,phiType.Data()),"recreate");
ofile_R->cd();
/*
...
TFile* ofile_P = new TFile(Form("Rootfiles/hist_dphi_1Dz_R%d_withdistortion_unweighted_%s.root",(int)selectR,phiType.Data()),"recreate");
ofile_P->cd();
/*
...
TFile* ofile_Z = new TFile(Form("Rootfiles/hist_dz_1Dz_R%d_withdistortion_unweighted_%s.root",(int)selectR,phiType.Data()),"recreate");
ofile_Z->cd();
/*
...
can->cd(2);
hists_CPM_sim_truth.h_P_pos->SetMinimum(-0.01); hists_CPM_sim_truth.h_P_pos->SetMaximum(0.01);
...
can->cd(4);
gPad->SetLogy(0);
hists_CPM_sim_truth.h_Z_pos->SetMinimum(-1); hists_CPM_sim_truth.h_Z_pos->SetMaximum(1);
...
can->cd(6);
hists_CPM_sim_truth.h_P_neg->SetMinimum(-0.01); hists_CPM_sim_truth.h_P_neg->SetMaximum(0.01);
...
can->cd(8);
gPad->SetLogy(0);
hists_CPM_sim_truth.h_Z_neg->SetMinimum(-1); hists_CPM_sim_truth.h_Z_neg->SetMaximum(1);
...
can->Update();
can->SaveAs(Form("figure/resid_vsZ_from3D_atR%d_withdistortion_unweighted_%s.pdf",(int)selectR,phiType.Data()));
...
legend->Draw();
can_leg->SaveAs(Form("figure/resid_vsZ_from3D_leg_withdistortion_unweighted_%s.pdf",phiType.Data()));
