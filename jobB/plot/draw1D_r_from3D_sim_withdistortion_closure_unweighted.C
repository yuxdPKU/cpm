...
void draw1D_r_from3D_sim_withdistortion_closure_unweighted(TString phiType="central")
{
gStyle->SetOptStat(0);
...
oneDHist hists_CPM_sim_acts, hists_CPM_sim_genfit, hists_CPM_sim_truth, hists_CPM_sim_input;
//draw1Dmap(Form("../output/sim_run%d_acts_unweighted/sim_run%d_acts_unweighted_maxdca0p2_B3_average_correction_histograms.root", run, run), Form("CPM_sim_reco_acts"), selectZ, selectPhi, hists_CPM_sim_acts, 2);
//draw1Dmap(Form("../output/sim_run%d_genfit_unweighted/sim_run%d_genfit_unweighted_maxdca0p2_B3_average_correction_histograms.root", run, run), Form("CPM_sim_reco_genfit"), selectZ, selectPhi, hists_CPM_sim_genfit, 3);
draw1Dmap(Form("../output/sim_run%d_truth_withdistortion_unweighted/sim_run%d_truth_withdistortion_unweighted_maxdca0p2_B3_average_correction_histograms.root", run, run), Form("CPM_sim_reco_truth_withdistortion"), selectZ, selectPhi, hists_CPM_sim_truth, 4);
draw1Dmap(Form("/phenix/u/hpereira/sphenix/work/g4simulations/distortion_maps/average_minus_static_distortion_converted.root"), Form("CPM_sim_input"), selectZ, selectPhi, hists_CPM_sim_input, 1, true);
...
hists_P.push_back(hists_CPM_sim_input.h_P_neg);
hists_P.push_back(hists_CPM_sim_input.h_P_pos);
/*
...
hists_R.push_back(hists_CPM_sim_input.h_R_neg);
hists_R.push_back(hists_CPM_sim_input.h_R_pos);
/*
...
hists_Z.push_back(hists_CPM_sim_input.h_Z_neg);
hists_Z.push_back(hists_CPM_sim_input.h_Z_pos);
...
TFile* ofile_N = new TFile(Form("Rootfiles/hist_n_1Dr_Z%d_withdistortion_unweighted_%s.root",(int)selectZ,phiType.Data()),"recreate");
ofile_N->cd();
/*
...
hists_CPM_sim_input.h_N_pos->Write();
hists_CPM_sim_input.h_N_neg->Write();
*/
ofile_N->Write();

TFile* ofile_R = new TFile(Form("Rootfiles/hist_dr_1Dr_Z%d_withdistortion_unweighted_%s.root",(int)selectZ,phiType.Data()),"recreate");
ofile_R->cd();
/*
...
hists_CPM_sim_input.h_R_pos->Write();
hists_CPM_sim_input.h_R_neg->Write();
ofile_R->Write();

TFile* ofile_P = new TFile(Form("Rootfiles/hist_dphi_1Dr_Z%d_withdistortion_unweighted_%s.root",(int)selectZ,phiType.Data()),"recreate");
ofile_P->cd();
/*
...
hists_CPM_sim_input.h_P_pos->Write();
hists_CPM_sim_input.h_P_neg->Write();
ofile_P->Write();

TFile* ofile_Z = new TFile(Form("Rootfiles/hist_dz_1Dr_Z%d_withdistortion_unweighted_%s.root",(int)selectZ,phiType.Data()),"recreate");
ofile_Z->cd();
/*
...
hists_CPM_sim_input.h_Z_pos->Write();
hists_CPM_sim_input.h_Z_neg->Write();
ofile_Z->Write();
...
//hists_CPM_sim_input.h_N_pos->Draw("hist,same");
can->cd(2);
hists_CPM_sim_truth.h_P_pos->SetMinimum(-0.01); hists_CPM_sim_truth.h_P_pos->SetMaximum(0.03);
...
hists_CPM_sim_input.h_P_pos->Draw("hist,same");
can->cd(3);
gPad->SetLogy(0);
hists_CPM_sim_truth.h_R_pos->SetMinimum(-0.5); hists_CPM_sim_truth.h_R_pos->SetMaximum(0.5);
...
hists_CPM_sim_input.h_R_pos->Draw("hist,same");
can->cd(4);
gPad->SetLogy(0);
hists_CPM_sim_truth.h_Z_pos->SetMinimum(-0.1); hists_CPM_sim_truth.h_Z_pos->SetMaximum(0.1);
...
hists_CPM_sim_input.h_Z_pos->Draw("hist,same");
can->cd(5);
gPad->SetLogy(1);
...
//hists_CPM_sim_input.h_N_neg->Draw("hist,same");
can->cd(6);
hists_CPM_sim_truth.h_P_neg->SetMinimum(-0.01); hists_CPM_sim_truth.h_P_neg->SetMaximum(0.03);
...
hists_CPM_sim_input.h_P_neg->Draw("hist,same");
can->cd(7);
gPad->SetLogy(0);
hists_CPM_sim_truth.h_R_neg->SetMinimum(-0.5); hists_CPM_sim_truth.h_R_neg->SetMaximum(0.5);
...
hists_CPM_sim_input.h_R_neg->Draw("hist,same");
can->cd(8);
gPad->SetLogy(0);
hists_CPM_sim_truth.h_Z_neg->SetMinimum(-0.1); hists_CPM_sim_truth.h_Z_neg->SetMaximum(0.1);
...
hists_CPM_sim_input.h_Z_neg->Draw("hist,same");

gPad->RedrawAxis();

can->Update();
can->SaveAs(Form("figure/resid_vsR_from3D_atZ%d_withdistortion_unweighted_%s.pdf",(int)selectZ,phiType.Data()));

TLegend *legend = new TLegend(0.1, 0.1, 0.9, 0.9);
legend->SetHeader("CPM unweighted");
...
legend->AddEntry(hists_CPM_sim_input.h_P_pos, Form("TRUTH"), "F");
legend->Draw();
TCanvas* can_leg = new TCanvas("can_leg","",1600,1200);
legend->Draw();
can_leg->SaveAs(Form("figure/resid_vsR_from3D_leg_withdistortion_unweighted_%s.pdf",phiType.Data()));
