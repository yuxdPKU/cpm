...
- Added the first B2 voxel accumulator macro. It reads B1 pair outputs, applies optional DCA and minimum-entry cuts, and writes one QA/correction-summary row per populated voxel while deferring the final correction-map sign convention.
