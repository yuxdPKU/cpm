...
- Renamed the B1 driver macro to `CPM_B1_ComputePoCA.C` and the default B1 intermediate output to `*_B1_poca.root`, because B1 is now solver-agnostic and defaults to the helix PoCA method rather than the original local line-line method.
